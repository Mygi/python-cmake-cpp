...
namespace cvnp
{
    ...
    {
        { CV_8U,  "CV_8U", pybind11::format_descriptor<uint8_t>::format(), "u", 1,   "np.uint8" },
        { CV_8S,  "CV_8S", pybind11::format_descriptor<int8_t>::format(), "i", 1,    "np.int8" },
        { CV_16U, "CV_16U", pybind11::format_descriptor<uint16_t>::format(), "u", 2, "np.uint16" },
        { CV_16S, "CV_16S", pybind11::format_descriptor<int16_t>::format(), "i", 2,  "np.int16" },
        { CV_32S, "CV_32S", pybind11::format_descriptor<int32_t>::format(), "i", 4,  "np.int32" },
        { CV_32F, "CV_32F", pybind11::format_descriptor<float>::format(), "f", 4,    "float" },
        { CV_64F, "CV_64F", pybind11::format_descriptor<double>::format(), "f", 8,   "np.float64" }
